<?php 
   ...
   $connect = connect();
   // sql语句
   $detail_sql = "select p.title, p.created, p.content, p.views, p.likes, c.name, u.nickname from posts p
     left join users u on p.user_id = u.id
     left join categories c on c.id = p.category_id
     where p.id = {$postId}";
   // 执行sql语句
   $detail_arr = query($connect, $detail_sql);
   // print_r($detail_arr);
 ?>
    ...
    <div class="content">
      <div class="article">
        <div class="breadcrumb">
          <dl>
            <dt>当前位置：</dt>
            <dd><a href="javascript:;"><?php echo $detail_arr[0]['name'] ?></a></dd>
            <dd><?php echo $detail_arr[0]['title'] ?></dd>
          </dl>
        </div>
        <h2 class="title">
          <a href="javascript:;"><?php echo $detail_arr[0]['title'] ?></a>
        </h2>
        <div class="meta">
          <span><?php echo $detail_arr[0]['nickname'] ?> 发布于 <?php echo $detail_arr[0]['created'] ?></span>
          <span>分类: <a href="javascript:;"><?php echo $detail_arr[0]['name'] ?></a></span>
          <span>阅读: (<?php echo $detail_arr[0]['views'] ?>)</span>
          <span>点赞: (<?php echo $detail_arr[0]['likes'] ?>)</span>
        </div>
        <div class="content-detail"><?php echo $detail_arr[0]['content'] ?></div>
      </div>
