...
<body>
      ...
      <form id="data-form" class="row">
        ...
        <div class="col-md-3">
          ...
          <div class="form-group">
            ...
            <input id="btn-save" class="btn btn-primary" type="button" value="保存"></button>
          </div>
        </div>
      </form>
    </div>
  ...
  <script>
     ...
     $("#feature").on("change", function(){
         ...
         $.ajax({
            type: 'post',
            url: './api/getFileData.php',
            data: data,          //此处不能写成{data}否则会报错误 
            contentType: false,  //只有设置这个属性，jquery才会把文件带回服务器
